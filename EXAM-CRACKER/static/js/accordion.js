...
function toggleSubcategory(e) {
    ...
    // Add ripple effect contained within subsection
...
function addRippleEffect(element, event) {
    ...
    ripple.style.cssText = `
        ...
        left: ${x}px;
        top: ${y}px;
        background: radial-gradient(circle, rgba(220, 38, 38, 0.6) 0%, rgba(220, 38, 38, 0.3) 50%, rgba(220, 38, 38, 0) 100%);
        border-radius: 50%;
        transform: scale(0);
...
function addSmoothScrolling() {
    // Only apply smooth scrolling to main subject headers, not subsections
    const accordionHeaders = document.querySelectorAll('.accordion-header');
